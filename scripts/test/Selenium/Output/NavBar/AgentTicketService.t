...
# --
# $origin: https://github.com/OTRS/otrs/blob/a11f0d7a1ed0174e796a11c9998cdb112d0624be/scripts/test/Selenium/Output/NavBar/AgentTicketService.t
# --
...
#        );
        ...
        # disable ticket service feature
        $SysConfigObject->ConfigItemUpdate(
            Valid => 1,
            Key   => 'Ticket::Service',
            Value => 0,

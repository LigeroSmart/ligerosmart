...
@apiParam (Request body) {String} Object Class Object from LigeroSmart Framework
@apiParam (Request body) {String} Method Object Method from LigeroSmart Framework. See methods here: https://docs.ligerosmart.org/6.1/perl-reference/
@apiParam (Request body) {String="HASH","ARRAY","SCALAR"} RetunType Object Method from LigeroSmart Framework

...
=pod
@api {post} /admin Execute requests for any internal Ligero framework functions
@apiName Admin
@apiGroup Admin
@apiVersion 1.0.0
...
@apiParam (Request body) {String} Object Name of class object from Ligero Framework
@apiParam (Request body) {String} Method Nome of method from Ligero Frameork
@apiParam (Request body) {String="HASH","ARRAY","SCALAR"} RetunType Nome of method from Ligero Frameork

...
=cut
=pod
@api {post} /kb/search Elastisearch searchs.
@apiName Search
@apiGroup Kb
@apiVersion 1.0.0
...
@apiParam (Request body) {Object} params Params object.
@apiParam (Request body) {Object} Query Object query elastic.
@apiParam (Request body) {Object} KBs Object KBs elastic.

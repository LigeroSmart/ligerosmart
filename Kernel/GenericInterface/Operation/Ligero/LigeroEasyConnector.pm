...
=cut
=pod
@api {post} /ticket/createorupdate Create or update a ticket.
...
@apiParam (Request body) {Object} [ControlSearch] Search control object to use to performe ticket search that will be updated.
...
@apiSuccessExample {json} Success example:
  HTTP/1.1 200 Success
  {
    ...
    "Ticket": {
      ...
      "StateID": 1,
      "GroupID": 1,
      "UnlockTimeout": 1622229023,
      "CustomerID": "",
      "TypeID": 1,
      "Created": "2021-05-28 18:39:27",
      "TicketNumber": "2021052810000014",
      "LockID": 1,
      "ResponsibleID": 1,
      "Responsible": "root@localhost",
      ...
      "Article": {
        ...
        "Bcc": "",
        "From": "ricardo.silva@complemento.ne.br",
        "ChangeTime": "2021-05-28 19:10:23",
        "Body": "Teste Attachment",
        "InReplyTo": "",
        "ReplyTo": "",
        "CreateTime": "2021-05-28 19:10:23",
        "TicketID": 2,
        "ContentType": "text/plain; charset=utf-8",
        "IsVisibleForCustomer": 1,
        "ArticleID": 34,

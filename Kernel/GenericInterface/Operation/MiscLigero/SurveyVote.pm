...
=pod
@api {post} /survey/vote Set survey results by customer.
@apiName Vote
@apiGroup Survey
@apiVersion 1.0.0
...
@apiParam (Request body) {String} PublicSurveyKey Survey key.
@apiParam (Request body) {Object} Answers List of survey (key:value).

@apiErrorExample {json} Error example:
  HTTP/1.1 200 Success
  {
    "Error": {
      "ErrorCode": "SurveyVote.AuthFail",
      "ErrorMessage": "SurveyVote: Authorization failing!"
    }
  }

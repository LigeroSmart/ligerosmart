...
=cut
=pod
@api {post} /cmdb/search Config item search api
@apiName Search
@apiGroup Cmdb
@apiVersion 1.0.0
...
@apiExample Example usage:
  {
    ...
    "ConfigItem": {
      ...
      "ConfigItemCreateTimeNewerDate": "2021-01-12 00:00:00",
      "ConfigItemCreateTimeOlderDate": "2021-12-12 00:00:00",
      "ConfigItemChangeTimeNewerDate": "2021-01-12 00:00:00",
      "ConfigItemChangeTimeOlderDate": "2021-12-12 00:00:00",
      "CIXMLData": {
        "NIC": {
            "IPoverDHCP": "Yes",
            "NIC": "Teste"
...
@apiParam (Request body) {Object} ConfigItem Cmdb data search object.
@apiParam (Request body) {String} [Class] Cmdb item class search.
@apiParam (Request body) {String} [Number] The ConfigItem Number.
@apiParam (Request body) {String} [Name] The ConfigItem Name.
@apiParam (Request body) {Array} [DeplStates] Array of deployment state.
@apiParam (Request body) {Array} [InciStates] Array of incident state.
@apiParam (Request body) {Array} [ConfigItemCreateTimeNewerDate] config items with created time after.
...
@apiSuccess {Array} ConfigItemIDs List of Cmdb IDs found.
=cut
sub Run {
    my ( $Self, %Param ) = @_;

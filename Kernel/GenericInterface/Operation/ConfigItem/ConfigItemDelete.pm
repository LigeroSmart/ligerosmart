...
@apiParam (Request body) {Integer} ConfigItemID Cmdb item ID to delete.

@apiErrorExample {json} Error example:
  HTTP/1.1 200 Success
  {
    "Error": {
      "ErrorMessage": "ConfigItemDelete: Can not delete configuration item!",
...
@apiSuccess {String} ConfigItemID List of Cmdb id deleted.
=cut
sub Run {
    my ( $Self, %Param ) = @_;

...
@apiParam (Request body) {Integer="0","1"} [ReplaceExistingData] Default is 0.
@apiParam (Request body) {String} ConfigItemID Cmdb item ID.
@apiParam (Request body) {Object} ConfigItem Object with all configuration to be setted on Cmdb Item
@apiParam (Request body) {String} [Number] Cmdb item nmber
@apiParam (Request body) {String} Class Cmdb class name. example: "Computer", "Hardware"
@apiParam (Request body) {String} Name Cmdb item name.

...
=pod
@api {post} /cmdb/create Executa requests para qualquer função interna do framework do ligero
@apiName Create
@apiGroup Cmdb
@apiVersion 1.0.0
...
@apiParam (Request body) {Sting} Object Name of class object from Ligero Framework
@apiParam (Request body) {String} Method Nome of method from Ligero Frameork
@apiParam (Request body) {String="HASH","ARRAY"} RetunType Nome of method from Ligero Frameork
@apiParam (Request body) {Object} [Params] Depends on the Method that are invocating

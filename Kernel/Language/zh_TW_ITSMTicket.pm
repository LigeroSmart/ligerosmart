# --
# Kernel/Language/zh_TW_ITSMTicket.pm - translation file
...
package Kernel::Language::zh_TW_ITSMTicket;
...
sub Data {
    ...
    $Self->{Translation}->{'Postponed'} = '推遲';
    $Self->{Translation}->{'Pre-approved'} = '預先核准';
    $Self->{Translation}->{'Rejected'} = '拒絕';

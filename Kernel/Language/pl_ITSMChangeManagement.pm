...
sub Data {
    ...
    $Self->{Translation}->{'Agent interface module to show the ChangeManager overview icon.'} = 'Moduł interfejsu agenta do wyświetlania ikony przeglądu Manager zmiany.';
    ...
    $Self->{Translation}->{'Agent interface module to show the MyWorkOrders overview icon.'} = 'Moduł interfejsu agenta do wyświetlania ikony przeglądu Moje zadania.';
    ...
    $Self->{Translation}->{'Clear'} = 'Wyczyść';
    $Self->{Translation}->{'Condition Edit'} = 'Edycja warunku';
    $Self->{Translation}->{'Conditions'} = 'Warunki';
    ...
    $Self->{Translation}->{'Templates'} = 'Szablony';
    ...
    $Self->{Translation}->{'WorkOrderHistory::WorkOrderActualEndTimeReachedWithWorkOrderID'} = 'Zadanie (ID=%s) osiągnęło rzeczywisty czas końca.';
    $Self->{Translation}->{'WorkOrderHistory::WorkOrderActualStartTimeReached'} = 'Zadanie (ID=%s) osiągnęło rzeczywisty czas startu.';
    $Self->{Translation}->{'WorkOrderHistory::WorkOrderActualStartTimeReachedWithWorkOrderID'} = 'Zadanie (ID=%s) osiągnęło rzeczywisty czas startu.';
    ...
    $Self->{Translation}->{'WorkOrderHistory::WorkOrderPlannedEndTimeReachedWithWorkOrderID'} = 'Zadanie (ID=%s) osiągnęło planowany czas końca.';
    $Self->{Translation}->{'WorkOrderHistory::WorkOrderPlannedStartTimeReached'} = 'Zadanie (ID=%s) osiągnęło planowany czas startu.';
    $Self->{Translation}->{'WorkOrderHistory::WorkOrderPlannedStartTimeReachedWithWorkOrderID'} = 'Zadanie (ID=%s) osiągnęło planowany czas startu.';
    ...
    $Self->{Translation}->{'Template'} = 'Szablon';
    ...
    $Self->{Translation}->{'Condition'} = 'Warunek';
    ...
    $Self->{Translation}->{'AccountedTime'} = 'Zliczony czas';
    ...
    $Self->{Translation}->{'Show or hide the content.'} = 'Pokaż lub ukryj zawartość.';
    ...
    $Self->{Translation}->{'You can not delete this Workorder. It is used in at least one Condition!'} = 'Nie możesz usunąć tego zadania. Jest ono używane w przynajmniej jednym warunku!';
    ...
    $Self->{Translation}->{'The actual start time must be set, when the actual end time is set!'} = 'Rzeczywisty czas startu musi być ustawiony gdy ustawiony jest rzeczywisty czas końca!';

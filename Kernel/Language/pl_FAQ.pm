...
# --
# $Id: pl_FAQ.pm,v 1.23 2012-01-26 16:37:39 mh Exp $
# --
...
sub Data {
    ...
    $Self->{Translation}->{'Latest updated FAQ articles'} = 'ostatnio zmienione artykuły';
    $Self->{Translation}->{'Latest created FAQ articles'} = 'ostatnio utworzone artykuły';
    $Self->{Translation}->{'Top 10 FAQ articles'} = '10 najlepszych artykułów';
    ...
    $Self->{Translation}->{'FAQ Articles (Top 10)'} = 'Zmiany w FAQ (10 najlepszych artykułów)';
    $Self->{Translation}->{'FAQ Articles (new created)'} = 'Zmiany w FAQ (nowe artykuły)';
    $Self->{Translation}->{'FAQ Articles (recently changed)'} = 'Zmiany w FAQ (zmienione artykuły)';

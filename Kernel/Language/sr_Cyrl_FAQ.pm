...
sub Data {
    ...
    $Self->{Translation}->{'Module to generate HTML OpenSearch profile for short FAQ search in the customer interface.'} =
        'Модул за генерисање „HTML OpenSearch” профила за кратку ЧПП претрагу у интерфејсу клијента.';
    ...
    $Self->{Translation}->{'The default languages for the related FAQ articles.'} = 'Подразумевани језици за повезане ЧПП чланаке.';

...
sub Data {
    ...
    $Self->{Translation}->{'ITSM event module deletes the history of changes.'} = '删除变更历史的ITSM事件模块。';
    ...
    $Self->{Translation}->{'ITSM event module updates the history of changes.'} = '更新变更历史的ITSM事件模块。';
    $Self->{Translation}->{'ITSM event module updates the history of conditions.'} = '更新条件历史的ITSM事件模块。';
    $Self->{Translation}->{'ITSM event module updates the history of workorders.'} = '更新工作指令历史的ITSM事件模块。';
    $Self->{Translation}->{'If frequency is \'regularly\', you can configure how often the notications are sent (every X hours).'} =
        '如果频率设置为“定期”，您可以配置发送通知的频率（每X小时）。';
    ...
    $Self->{Translation}->{'Show this screen after I created a new workorder'} = '创建工作指令后显示的窗口';
    ...
    $Self->{Translation}->{'Shows a link in the menu that allows changing the work order agent, in the zoom view of such work order of the agent interface.'} =
        '在服务人员界面工作指令详情窗口，在菜单中显示一个允许更换工作指令服务人员的链接。';
    ...
    $Self->{Translation}->{'Shows a link in the menu that allows linking a work order with another object in the zoom view of such work order of the agent interface.'} =
        '在服务人员界面工作指令详情窗口，在菜单中显示一个允许链接工作指令到另一对象的链接。';
    ...
    $Self->{Translation}->{'Shows a link in the menu that allows taking a work order in the its zoom view of the agent interface.'} =
        '在服务人员界面工作指令详情窗口，在菜单中显示一个允许接手工作指令的链接。';

...
# --
# $Id: ms_ITSMChangeManagement.pm,v 1.1 2013-04-18 16:34:32 ub Exp $
# --
...
sub Data {
    ...
    $Self->{Translation}->{'Agent interface module to show the ChangeManager overview icon.'} = 'Modul ejen interface untuk menunjukkan PerubahanPengurusan melihat semula ikon.';
    ...
    $Self->{Translation}->{'Agent interface module to show the MyWorkOrders overview icon.'} = 'Modul ejen interface untuk menunjukkan UrutanKerjaSaya melihat semula ikon.';
    ...
    $Self->{Translation}->{'Clear'} = 'Jelas';
    $Self->{Translation}->{'Condition Edit'} = 'Audit Syarat';
    $Self->{Translation}->{'Conditions'} = 'Syarat';
    ...
    $Self->{Translation}->{'Templates'} = 'Templat';
    ...
    $Self->{Translation}->{'WorkOrderHistory::WorkOrderActualEndTimeReachedWithWorkOrderID'} = 'Perintah Kerja (ID=%s) berakhir.';
    $Self->{Translation}->{'WorkOrderHistory::WorkOrderActualStartTimeReached'} = 'Perintah kerja (ID=%s) bermula.';
    $Self->{Translation}->{'WorkOrderHistory::WorkOrderActualStartTimeReachedWithWorkOrderID'} = 'Perintah kerja (ID=%s) bermula.';
    ...
    $Self->{Translation}->{'WorkOrderHistory::WorkOrderPlannedEndTimeReachedWithWorkOrderID'} = 'Perintah kerja (ID=%s) sampai akhir dijadualkan.';
    $Self->{Translation}->{'WorkOrderHistory::WorkOrderPlannedStartTimeReached'} = 'Perintah Kerja (ID=%s) sampai dijadualkan masa mula.';
    $Self->{Translation}->{'WorkOrderHistory::WorkOrderPlannedStartTimeReachedWithWorkOrderID'} = 'Perintah Kerja (ID=%s) sampai dijadualkan masa mula.';
    ...
    $Self->{Translation}->{'Manage the priority result of combinating Category <-> Impact.'} = 'Pentadbiran gabungan kategori keutamaan <-> Impak.';
    ...
    $Self->{Translation}->{'Template'} = 'Templat';
    ...
    $Self->{Translation}->{'Condition'} = 'Kondisi';
    ...
    $Self->{Translation}->{'Details'} = 'Terperinchi';
    ...
    $Self->{Translation}->{'AccountedTime'} = 'masa yang diperlukan';
    ...
    $Self->{Translation}->{'You can not delete this Workorder. It is used in at least one Condition!'} = 'Anda tidak boleh memadam ini Tata Kerja. Ia digunakan dalam sekurang-kurangnya satu Keadaan!';
    ...
    $Self->{Translation}->{'The actual start time must be set, when the actual end time is set!'} = 'Masa mula sebenar mesti ditetapkan, apabila akhir zaman sebenar ditetapkan!';
    ...
    # SysConfig
    $Self->{Translation}->{'A list of the agents who have permission to take workorders. Key is a login name. Content is 0 or 1.'} = 'Satu senarai agen yang mempunyai kebenaran untuk mengambil pesanan kerja. Utama adalah nama log masuk. Kandungan adalah 0 atau 1';
    $Self->{Translation}->{'A list of workorder states, at which the ActualStartTime of a workorder will be set if it was empty at this point.'} = 'Satu senarai status pesanan kerja, di mana Masa Mula sebenar perintah kerja akan ditetapkan jika ia adalah kosong pada ketika ini.';
    $Self->{Translation}->{'Adapts the width of the autocomplete drop down to the length of the longest option.'} = 'Menyesuaikan diri lebar kejatuhan autoselesai ke panjang pilihan terpanjang.';
    ...
    $Self->{Translation}->{'Agent interface notification module to see the number of change advisory boards.'} = 'Agen antara muka modul pemberitahuan untuk melihat bilangan menukar lembaga penasihat.';
    $Self->{Translation}->{'Agent interface notification module to see the number of changes managed by the user.'} = 'Agen antara muka modul pemberitahuan untuk melihat beberapa perubahan yang diuruskan oleh pengguna.';
    $Self->{Translation}->{'Agent interface notification module to see the number of changes.'} = 'Agen antara muka modul pemberitahuan untuk melihat beberapa perubahan.';
    $Self->{Translation}->{'Agent interface notification module to see the number of work orders.'} = 'Agen antara muka modul pemberitahuan untuk melihat nombor pesanan kerja.';
    ...
    $Self->{Translation}->{'Configures how often the notifications are sent when planned the start time or other time values have been reached/passed.'} = 'Dikonfigurasi berapa kerap pemberitahuan akan dihantar apabila merancang masa mula atau nilai masa lain telah mencapai / diluluskan.';
    $Self->{Translation}->{'Default type for a workorder. This entry must exist in general catalog class \'ITSM::ChangeManagement::WorkOrder::Type\'.'} = 'Jenis lalai untuk perintah kerja. Entri ini mesti wujud di dalam kelas katalog am \'ITSM::Pengurusan Perubahan::Perintah Kerja::Jenis\'.';
    $Self->{Translation}->{'Define the signals for each workorder state.'} = 'Tentukan isyarat untuk setiap keadaan perintah kerja.';
    $Self->{Translation}->{'Defines an overview module to show the small view of a change list.'} = 'Mentakrifkan modul gambaran untuk menunjukkan pandangan yang kecil senarai perubahan.';
    $Self->{Translation}->{'Defines an overview module to show the small view of a template list.'} = 'Mentakrifkan modul gambaran untuk menunjukkan pandangan yang kecil senarai templat.';
    ...
    $Self->{Translation}->{'Defines if the change state can be set in AgentITSMChangeEdit.'} = 'Mentakrifkan jika keadaan perubahan boleh ditetapkan dalam AgentITSMChangeEdit.';
    ...
    $Self->{Translation}->{'Defines if the requested date should be searched by customer.'} = 'Mentakrifkan jika tarikh yang diminta perlu dicari oleh pelanggan.';
    ...
    $Self->{Translation}->{'Defines that only changes containing Workorders linked with services, which the customer user has permission to use will be shown. Any other changes will not be displayed.'} = 'Mentakrifkan bahawa perubahan hanya mengandungi Workorders dikaitkan dengan perkhidmatan, pengguna pelanggan yang mempunyai kebenaran untuk menggunakan akan ditunjukkan. Sebarang perubahan lain tidak akan dipaparkan.';
    $Self->{Translation}->{'Defines the change states that will be used as filters in the Change PSA overview.'} = 'Mentakrifkan keadaan perubahan yang akan digunakan sebagai penapis dalam gambaran PSA Perubahan.';
    $Self->{Translation}->{'Defines the change states that will be used as filters in the Change Schedule overview.'} = 'Mentakrifkan keadaan perubahan yang akan digunakan sebagai penapis dalam gambaran Jadual Perubahan.';
    $Self->{Translation}->{'Defines the change states that will be used as filters in the MyCAB overview.'} = 'Mentakrifkan keadaan perubahan yang akan digunakan sebagai penapis dalam gambaran MyCAB.';
    $Self->{Translation}->{'Defines the change states that will be used as filters in the MyChanges overview.'} = 'Mentakrifkan keadaan perubahan yang akan digunakan sebagai penapis dalam gambaran MyChanges.';
    $Self->{Translation}->{'Defines the change states that will be used as filters in the change manager overview.'} = 'Mentakrifkan keadaan perubahan yang akan digunakan sebagai penapis dalam gambaran pengurus perubahan.';
    $Self->{Translation}->{'Defines the change states that will be used as filters in the change overview.'} = 'Mentakrifkan keadaan perubahan yang akan digunakan sebagai penapis dalam gambaran perubahan.';
    $Self->{Translation}->{'Defines the change states that will be used as filters in the customer change schedule overview.'} = 'Mentakrifkan negeri perubahan yang akan digunakan sebagai penapis dalam perubahan jadual gambaran keseluruhan pelanggan.';
    ...
    $Self->{Translation}->{'Defines the default sort criteria in the change PSA overview.'} = 'Mentakrifkan kriteria jenis lalai dalam gambaran keseluruhan PSA perubahan.';
    $Self->{Translation}->{'Defines the default sort criteria in the change manager overview.'} = 'Mentakrifkan kriteria jenis lalai dalam gambaran pengurus perubahan.';
    ...
    $Self->{Translation}->{'Defines the default sort criteria in the change schedule overview.'} = 'SMentakrifkan kriteria jenis lalai dalam gambaran keseluruhan jadual perubahan.';
    $Self->{Translation}->{'Defines the default sort criteria of the changes in the MyCAB overview.'} = 'Mentakrifkan kriteria jenis lalai perubahan dalam gambaran MyCAB.';
    $Self->{Translation}->{'Defines the default sort criteria of the changes in the MyChanges overview.'} = 'Mentakrifkan kriteria jenis lalai perubahan dalam gambaran MyChanges.';
    $Self->{Translation}->{'Defines the default sort criteria of the changes in the MyWorkorders overview.'} = 'Mentakrifkan kriteria jenis lalai perubahan dalam gambaran keseluruhan pesanan Kerja.';
    $Self->{Translation}->{'Defines the default sort criteria of the changes in the PIR overview.'} = 'Mentakrifkan kriteria jenis lalai perubahan dalam gambaran PIR.';
    $Self->{Translation}->{'Defines the default sort criteria of the changes in the customer change schedule overview.'} = 'Mentakrifkan kriteria apapun lalai perubahan dalam perubahan jadual gambaran keseluruhan pelanggan.';
    $Self->{Translation}->{'Defines the default sort criteria of the changes in the template overview.'} = 'Mentakrifkan kriteria jenis lalai perubahan dalam gambaran templat.';
    ...
    $Self->{Translation}->{'Defines the default sort order in the MyWorkorders overview.'} = 'Mentakrifkan perintah lalai apapun dalam gambaran keseluruhan pesanan Kerja.';
    ...
    $Self->{Translation}->{'Defines the default sort order in the change manager overview.'} = 'Mentakrifkan perintah lalai jenis dalam gambaran pengurus perubahan.';
    ...
    $Self->{Translation}->{'Defines the default sort order in the change schedule overview.'} = 'Mentakrifkan perintah lalai jenis dalam gambaran keseluruhan jadual perubahan.';
    $Self->{Translation}->{'Defines the default sort order in the customer change schedule overview.'} = 'Mentakrifkan perintah lalai apapun dalam perubahan jadual gambaran keseluruhan pelanggan.';
    ...
    $Self->{Translation}->{'Defines the field type of CompareValue fields for change attributes used in AgentITSMChangeConditionEdit. Valid values are Selection, Text and Date. If a type is not defined, the field will not be shown.'} = 'Mentakrifkan jenis bidang bidang Banding Nilai untuk sifat-sifat perubahan yang digunakan dalam AgentITSMChangeConditionEdit. Nilai yang sah Pemilihan, Teks dan Tarikh. Jika jenis tidak ditakrifkan, padang tidak akan ditunjukkan.';
    $Self->{Translation}->{'Defines the field type of CompareValue fields for workorder attributes used in AgentITSMChangeConditionEdit. Valid values are Selection, Text and Date. If a type is not defined, the field will not be shown.'} = 'Mentakrifkan jenis bidang bidang Banding Nilai untuk sifat-sifat perintah kerja yang digunakan dalam AgentITSMChangeConditionEdit. Nilai yang sah Pemilihan, Teks dan Tarikh. Jika jenis tidak ditakrifkan, padang tidak akan ditunjukkan.';
    ...
    $Self->{Translation}->{'Defines the object attributes that are selectable for change objects in AgentITSMChangeConditionEdit.'} = 'Mentakrifkan sifat-sifat objek yang dipilih untuk objek perubahan dalam AgentITSMChangeConditionEdit.';
    $Self->{Translation}->{'Defines the object attributes that are selectable for workorder objects in AgentITSMChangeConditionEdit.'} = 'Mentakrifkan sifat-sifat objek yang dipilih untuk objek perintah kerja dalam AgentITSMChangeConditionEdit.';
    $Self->{Translation}->{'Defines the operators that are selectable for the attribute AccountedTime in AgentITSMChangeConditionEdit.'} = 'Mentakrifkan pengendali yang dipilih untuk AccountedTime atribut dalam AgentITSMChangeConditionEdit.';
    $Self->{Translation}->{'Defines the operators that are selectable for the attribute ActualEndTime in AgentITSMChangeConditionEdit.'} = 'Mentakrifkan pengendali yang dipilih untuk ActualEndTime atribut dalam AgentITSMChangeConditionEdit.';
    $Self->{Translation}->{'Defines the operators that are selectable for the attribute ActualStartTime in AgentITSMChangeConditionEdit.'} = 'Mentakrifkan pengendali yang dipilih untuk ActualStartTime atribut dalam AgentITSMChangeConditionEdit.';
    $Self->{Translation}->{'Defines the operators that are selectable for the attribute CategoryID in AgentITSMChangeConditionEdit.'} = 'Mentakrifkan pengendali yang boleh dipilih untuk ID Kategori atribut dalam AgentITSMChangeConditionEdit.';
    $Self->{Translation}->{'Defines the operators that are selectable for the attribute ChangeBuilderID in AgentITSMChangeConditionEdit.'} = 'Mentakrifkan pengendali yang boleh dipilih untuk atribut ChangeBuilderID dalam AgentITSMChangeConditionEdit.';
    $Self->{Translation}->{'Defines the operators that are selectable for the attribute ChangeFreeKey in AgentITSMChangeConditionEdit.'} = 'Mentakrifkan pengendali yang dipilih untuk ChangeFreeKey atribut dalam AgentITSMChangeConditionEdit.';
    $Self->{Translation}->{'Defines the operators that are selectable for the attribute ChangeFreeText in AgentITSMChangeConditionEdit.'} = 'Mentakrifkan pengendali yang boleh dipilih untuk FreeText Perubahan atribut dalam AgentITSMChangeConditionEdit.';
    $Self->{Translation}->{'Defines the operators that are selectable for the attribute ChangeManagerID in AgentITSMChangeConditionEdit.'} = 'Mentakrifkan pengendali yang boleh dipilih untuk atribut ChangeManagerID dalam AgentITSMChangeConditionEdit.';
    $Self->{Translation}->{'Defines the operators that are selectable for the attribute ChangeStateID in AgentITSMChangeConditionEdit.'} = 'Mentakrifkan pengendali yang boleh dipilih untuk atribut ChangeStateID dalam AgentITSMChangeConditionEdit.';
    $Self->{Translation}->{'Defines the operators that are selectable for the attribute ChangeTitle in AgentITSMChangeConditionEdit.'} = 'Mentakrifkan pengendali yang boleh dipilih untuk Perubahan Tajuk atribut dalam AgentITSMChangeConditionEdit.';
    $Self->{Translation}->{'Defines the operators that are selectable for the attribute ImpactID in AgentITSMChangeConditionEdit.'} = 'Mentakrifkan pengendali yang boleh dipilih untuk atribut ImpactID dalam AgentITSMChangeConditionEdit.';
    $Self->{Translation}->{'Defines the operators that are selectable for the attribute PlannedEffort in AgentITSMChangeConditionEdit.'} = 'Mentakrifkan pengendali yang boleh dipilih untuk Usaha sifat yang dirancang dalam AgentITSMChangeConditionEdit.';
    $Self->{Translation}->{'Defines the operators that are selectable for the attribute PlannedEndTime in AgentITSMChangeConditionEdit.'} = 'Mentakrifkan pengendali yang dipilih untuk atribut Dirancang Masa Tamat dalam AgentITSMChangeConditionEdit.';
    $Self->{Translation}->{'Defines the operators that are selectable for the attribute PlannedStartTime in AgentITSMChangeConditionEdit.'} = 'Mentakrifkan pengendali yang dipilih untuk atribut Dirancang Mula Masa dalam AgentITSMChangeConditionEdit.';
    $Self->{Translation}->{'Defines the operators that are selectable for the attribute PriorityID in AgentITSMChangeConditionEdit.'} = 'Mentakrifkan pengendali yang boleh dipilih untuk ID Keutamaan atribut dalam AgentITSMChangeConditionEdit.';
    $Self->{Translation}->{'Defines the operators that are selectable for the attribute RequestedTime in AgentITSMChangeConditionEdit.'} = 'Mentakrifkan pengendali yang dipilih untuk atribut Diminta Masa dalam AgentITSMChangeConditionEdit.';
    $Self->{Translation}->{'Defines the operators that are selectable for the attribute WorkOrderAgentID in AgentITSMChangeConditionEdit.'} = 'Mentakrifkan pengendali yang boleh dipilih untuk atribut WorkOrderAgentID dalam AgentITSMChangeConditionEdit.';
    $Self->{Translation}->{'Defines the operators that are selectable for the attribute WorkOrderFreeKey in AgentITSMChangeConditionEdit.'} = 'Mentakrifkan pengendali yang dipilih untuk WorkOrderFreeKey atribut dalam AgentITSMChangeConditionEdit.';
    $Self->{Translation}->{'Defines the operators that are selectable for the attribute WorkOrderFreeText in AgentITSMChangeConditionEdit.'} = 'Mentakrifkan pengendali yang boleh dipilih untuk Teks atribut Perintah Kerja Percuma di AgentITSMChangeConditionEdit.';
    $Self->{Translation}->{'Defines the operators that are selectable for the attribute WorkOrderNumber in AgentITSMChangeConditionEdit.'} = 'Mentakrifkan pengendali yang boleh dipilih untuk Nombor atribut Perintah Kerja dalam AgentITSMChangeConditionEdit.';
    $Self->{Translation}->{'Defines the operators that are selectable for the attribute WorkOrderStateID in AgentITSMChangeConditionEdit.'} = 'Mentakrifkan pengendali yang boleh dipilih untuk Kerja atribut ID Pesanan Keadaan dalam AgentITSMChangeConditionEdit.';
    $Self->{Translation}->{'Defines the operators that are selectable for the attribute WorkOrderTitle in AgentITSMChangeConditionEdit.'} = 'Mentakrifkan pengendali yang boleh dipilih untuk Tajuk atribut Perintah Kerja dalam AgentITSMChangeConditionEdit.';
    $Self->{Translation}->{'Defines the operators that are selectable for the attribute WorkOrderTypeID in AgentITSMChangeConditionEdit.'} = 'Mentakrifkan pengendali yang boleh dipilih untuk Kerja atribut Jenis ID Perintah AgentITSMChangeConditionEdit.';
    $Self->{Translation}->{'Defines the period (in years), in which start and end times can be selected.'} = 'Mentakrifkan tempoh (dalam tahun), di mana mula dan akhir kali boleh dipilih.';
    $Self->{Translation}->{'Defines the shown columns in the Change PSA overview. This option has no effect on the position of the column.'} = 'Mentakrifkan lajur menunjukkan gambaran PSA Perubahan. Pilihan ini tidak mempunyai kesan ke atas kedudukan tiang.';
    $Self->{Translation}->{'Defines the shown columns in the Change Schedule overview. This option has no effect on the position of the column.'} = 'Mentakrifkan lajur menunjukkan dalam gambaran Jadual Perubahan. Pilihan ini tidak mempunyai kesan ke atas kedudukan tiang.';
    $Self->{Translation}->{'Defines the shown columns in the MyCAB overview. This option has no effect on the position of the column.'} = 'Mentakrifkan ruangan menunjukkan dalam gambaran MyCAB. Pilihan ini tidak mempunyai kesan ke atas kedudukan tiang.';
    $Self->{Translation}->{'Defines the shown columns in the MyChanges overview. This option has no effect on the position of the column.'} = 'Mentakrifkan ruangan yang ditunjukkan dalam gambaran MyChanges. Pilihan ini tidak mempunyai kesan ke atas kedudukan tiang.';
    $Self->{Translation}->{'Defines the shown columns in the MyWorkorders overview. This option has no effect on the position of the column.'} = 'Mentakrifkan lajur menunjukkan gambaran keseluruhan Pesanan Kerja Saya. Pilihan ini tidak mempunyai kesan ke atas kedudukan tiang.';
    $Self->{Translation}->{'Defines the shown columns in the PIR overview. This option has no effect on the position of the column.'} = 'Mentakrifkan ruangan yang ditunjukkan dalam gambaran PIR. Pilihan ini tidak mempunyai kesan ke atas kedudukan tiang.';
    $Self->{Translation}->{'Defines the shown columns in the change manager overview. This option has no effect on the position of the column.'} = 'Mentakrifkan ruangan yang ditunjukkan dalam gambaran keseluruhan pengurus perubahan. Pilihan ini tidak mempunyai kesan ke atas kedudukan tiang.';
    $Self->{Translation}->{'Defines the shown columns in the change overview. This option has no effect on the position of the column.'} = 'Mentakrifkan ruangan yang ditunjukkan dalam gambaran perubahan. Pilihan ini tidak mempunyai kesan ke atas kedudukan tiang.';
    $Self->{Translation}->{'Defines the shown columns in the change search. This option has no effect on the position of the column.'} = 'Mentakrifkan ruangan yang ditunjukkan dalam carian perubahan. Pilihan ini tidak mempunyai kesan ke atas kedudukan tiang.';
    $Self->{Translation}->{'Defines the shown columns in the customer change schedule overview. This option has no effect on the position of the column.'} = 'Mentakrifkan ruangan yang ditunjukkan dalam perubahan jadual gambaran keseluruhan pelanggan. Pilihan ini tidak mempunyai kesan ke atas kedudukan tiang.';
    $Self->{Translation}->{'Defines the shown columns in the template overview. This option has no effect on the position of the column.'} = 'Mentakrifkan ruangan yang ditunjukkan dalam gambaran template. Pilihan ini tidak mempunyai kesan ke atas kedudukan tiang.';
    $Self->{Translation}->{'Defines the signals for each ITSMChange state.'} = 'Mentakrifkan isyarat untuk setiap keadaan Perubahan ITSM.';
    $Self->{Translation}->{'Defines the template types that will be used as filters in the template overview.'} = 'Mentakrifkan jenis template yang akan digunakan sebagai penapis dalam gambaran template.';
    $Self->{Translation}->{'Defines the workorder states that will be used as filters in the MyWorkorders overview.'} = 'Mentakrifkan status kerja perintah yang akan digunakan sebagai penapis dalam gambaran keseluruhan Kerja pesanan saya.';
    $Self->{Translation}->{'Defines the workorder states that will be used as filters in the PIR overview.'} = 'Mentakrifkan status kerja perintah yang akan digunakan sebagai penapis dalam gambaran PIR.';
    $Self->{Translation}->{'Defines the workorder types that will be used to show the PIR overview.'} = 'Mentakrifkan jenis perintah kerja yang akan digunakan untuk menunjukkan gambaran PIR.';
    $Self->{Translation}->{'Defines whether notifications should be sent.'} = 'Mentakrifkan sama ada pemberitahuan hendaklah dihantar.';
    $Self->{Translation}->{'Determines if an agent can exchange the X-axis of a stat if he generates one.'} = 'Menentukan jika ejen boleh bertukar-tukar X-paksi bintang jika dia menjana.';
    $Self->{Translation}->{'Determines if the common stats module may generate stats about changes done for config item classes.'} = 'Menentukan jika modul statistik biasa boleh menjana statistik tentang perubahan yang dilakukan bagi kelas item config.';
    $Self->{Translation}->{'Determines if the common stats module may generate stats about changes regarding change state updates within a timeperiod.'} = 'Menentukan jika modul statistik biasa boleh menjana statistik tentang perubahan mengenai kemaskini negeri perubahan dalam tempoh masa yang.';
    $Self->{Translation}->{'Determines if the common stats module may generate stats about changes regarding the relation between changes and incident tickets.'} = 'Menentukan jika modul statistik biasa boleh menjana statistik mengenai perubahan mengenai hubungan antara perubahan dan tiket kejadian.';
    $Self->{Translation}->{'Determines if the common stats module may generate stats about changes.'} = 'Menentukan jika modul statistik biasa boleh menjana statistik mengenai perubahan.';
    $Self->{Translation}->{'Determines if the common stats module may generate stats about the number of Rfc tickets a requester created.'} = 'Menentukan jika modul statistik biasa boleh menjana statistik mengenai bilangan tiket RFC peminta dicipta.';
    ...
    $Self->{Translation}->{'Enables or disables the autocomplete feature for the CAB member search in the ITSM agent interface.'} = 'Mendaya atau melumpuhkan ciri auto lengkap untuk carian ahli CAB di muka ejen ITSM.';
    $Self->{Translation}->{'Enables or disables the autocomplete feature for the customer search in the ITSM agent interface.'} = 'Mendaya atau menyahdaya ciri auto lengkap untuk carian pelanggan di muka ejen ITSM.';
    $Self->{Translation}->{'Enables or disables the autocomplete feature for the user search in the ITSM agent interface.'} = 'Mendaya atau menyahdaya ciri auto lengkap untuk carian pengguna di muka ejen ITSM.';
    ...
    $Self->{Translation}->{'ITSM event module that matches conditions and executes actions.'} = 'ITSM modul acara yang sepadan dengan keadaan dan melaksanakan tindakan.';
    ...
    $Self->{Translation}->{'ITSM event module to set the actual start and end times of workorders.'} = 'ITSM modul acara untuk menetapkan permulaan sebenar dan masa akhir pesanan kerja.';
    ...
    $Self->{Translation}->{'If frequency is \'regularly\', you can configure how often the notications are sent (every X hours).'} = 'Jika frekuensi \'kerap \', anda boleh menatarajah berapa kerap pemberitahuan dihantar (setiap jam X).';
    $Self->{Translation}->{'Logfile for the ITSM change counter. This file is used for creating the change numbers.'} = 'Fail Log untuk kaunter perubahan ITSM. Fail ini digunakan untuk mewujudkan nombor perubahan.';
    ...
    $Self->{Translation}->{'Module to check whether the agent is contained in the configured list.'} = 'Modul untuk memeriksa sama ada ejen itu terkandung dalam senarai dikonfigurasikan.';
    $Self->{Translation}->{'Module to show a link to create a change from this ticket. The ticket will be automatically linked with the new change.'} = 'Modul untuk menunjukkan pautan untuk membuat perubahan dari tiket ini. Tiket akan secara automatik dikaitkan dengan perubahan baru.';
    $Self->{Translation}->{'Notification (ITSM Change Management)'} = 'Pemberitahuan (Pengurusan Perubahan ITSM)';
    $Self->{Translation}->{'Only users of these groups have the permission to use the ticket types as defined in "ITSMChange::AddChangeLinkTicketTypes" if the feature "Ticket::Acl::Module###200-Ticket::Acl::Module" is enabled.'} = 'Hanya pengguna kumpulan-kumpulan ini mempunyai kebenaran untuk menggunakan jenis tiket seperti yang ditakrifkan dalam "ITSMChange :: AddChangeLinkTicketTypes" jika ciri "Tiket :: ACL :: Modul # # # 200-Tiket :: ACL :: Modul" diaktifkan.';
    $Self->{Translation}->{'Parameters for the pages (in which the changes are shown) of the small change overview.'} = 'Parameter untuk halaman (di mana perubahan ditunjukkan) gambaran perubahan kecil.';
    $Self->{Translation}->{'Presents a link in the menu to show the involved persons in a change, in the zoom view of such change in the agent interface.'} = 'Hadir pautan dalam menu untuk menunjukkan orang-orang yang terlibat dalam perubahan, dalam pandangan zoom perubahan dalam antara muka ejen';
    $Self->{Translation}->{'Required privileges in order for an agent to take a workorder.'} = 'Keistimewaan Diperlukan dalam usaha untuk ejen untuk mengambil perintah kerja.';
    ...
    $Self->{Translation}->{'Required privileges to create a template from a changes\' CAB.'} = 'Keistimewaan yang diperlukan untuk membuat template dari perubahan CAB.';
    ...
    $Self->{Translation}->{'Required privileges to edit the involved persons of a change.'} = 'Keistimewaan yang diperlukan untuk mengedit orang yang terlibat perubahan.';
    ...
    $Self->{Translation}->{'Required privileges to view list of changes where the user is a CAB member.'} = 'Keistimewaan Diperlukan untuk melihat senarai perubahan di mana pengguna adalah ahli CAB.';
    $Self->{Translation}->{'Required privileges to view list of changes where the user is the change manager.'} = 'Keistimewaan Diperlukan untuk melihat senarai perubahan di mana pengguna adalah pengurus perubahan.';
    ...
    $Self->{Translation}->{'Required privileges to view the history zoom of a workorder.'} = 'Keistimewaan yang diperlukan untuk melihat sejarah zoom perintah kerja.';
    ...
    $Self->{Translation}->{'Required privileges to view the list of changes with an upcoming PIR (Post Implementation Review).'} = 'Keistimewaan yang diperlukan untuk melihat senarai perubahan dengan PIR akan datang (Post Implementation Review).';
    ...
    $Self->{Translation}->{'Selects the change number generator module. With "Date", the change numbers will be generated by the current date and a counter; this format looks like Year.Month.Day.counter, e.g. 2010062400001, 2010062400002. With "DateChecksum", the counter will be appended as checksum to the string of date plus the SystemID. The checksum will be rotated on a daily basis. This format looks like Year.Month.Day.SystemID.Counter.CheckSum, e.g. 2010062410000017, 2010062410000026.'} = 'Memilih bilangan penjana perubahan modul. Dengan "Tarikh", nombor perubahan akan dijana oleh tarikh semasa dan kaunter; format ini kelihatan seperti Year.Month.Day.counter, contohnya 2010062400001, 2010062400002. Di Dengan "DateChecksum", kaunter akan dilampirkan sebagai checksum kepada rentetan tarikh ditambah Undur. Checksum akan diputar pada setiap hari. Format ini kelihatan seperti Year.Month.Day.SystemID.Counter.CheckSum, contohnya 2010062410000017, 2010062410000026.';
    $Self->{Translation}->{'Sets the maximal number of search results for the autocomplete feature.'} = 'Menetapkan bilangan maksimum hasil carian bagi ciri autoselesai.';
    ...
    $Self->{Translation}->{'Shows a link in the menu that allows changing the work order agent, in the zoom view of such work order of the agent interface.'} = 'Menunjukkan pautan dalam menu yang membolehkan menukar ejen kerja perintah, memandangkan zoom perintah kerja itu antara muka ejen';
    ...
    $Self->{Translation}->{'The identifier for a change, e.g. Change#, MyChange#. The default is Change#.'} = 'Pengecam untuk perubahan, i. Perubahan# Perubahan Saya#. Lalai adalah Perubahan#.';
    $Self->{Translation}->{'The identifier for a workorder, e.g. Workorder#, MyWorkorder#. The default is Workorder#.'} = 'Pengecam untuk mendapatkan perintah kerja, misalnya Workorder# Workorder#. Lalai adalah Perintah Kerja#.';
    $Self->{Translation}->{'This ACL module restricts the usuage of the ticket types that are defined in the sysconfig option \'ITSMChange::AddChangeLinkTicketTypes\', to users of the groups as defined in "ITSMChange::RestrictTicketTypes::Groups".'} = 'Modul ACL menghadkan usuage jenis tiket yang ditakrifkan dalam pilihan sysconfig \'ITSMChange::AddChangeLinkTicketTypes\', kepada pengguna kumpulan sebagaimana yang ditakrifkan dalam "ITSMChange::RestrictTicketTypes::Kumpulan".';
    $Self->{Translation}->{'Types of tickets, where in the ticket zoom view a link to add a change will be displayed.'} = 'Jenis-jenis tiket, di mana dalam zoom tiket melihat pautan untuk menambah perubahan akan dipaparkan.';

...
sub Data {
    ...
    # Template: AgentTimeAccounting
        ...
        'Can\'t save settings, because the Period is bigger than the interval between Starttime and Endtime!' => 'Nicht speicherbar - Dauer ist größer als der Zeitraum zwischen Beginn und Ende!',
        ...
        'Are you sure, that you worked while you have overtime?' => 'Haben Sie während der Überstunden auch gearbeitet?',

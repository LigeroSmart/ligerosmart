...
sub Data {
    ...
    $Self->{Translation}->{'No SLAID is given!'} = 'Није дат ИД SLA!';
    $Self->{Translation}->{'SLAID %s not found in database!'} = 'SLA ИД %s није нађен у бази података!';
    $Self->{Translation}->{'Calendar Default'} = 'Подразумевани календар';

    # Perl Module: Kernel/Modules/AgentITSMServicePrint.pm
    $Self->{Translation}->{'No ServiceID is given!'} = 'Није дат ИД Сервиса!';
    $Self->{Translation}->{'ServiceID %s not found in database!'} = 'ИД Сервиса "%s" није нађен у бази података!';
    $Self->{Translation}->{'Current Incident State'} = 'Тренутно стање инцидента';
    ...
    $Self->{Translation}->{'IT Operational'} = 'ИТ - оперативно';
    ...
    $Self->{Translation}->{'Module to show back link in service menu.'} = 'Модул за приказ везе за враћање у сервисном менију.';
    $Self->{Translation}->{'Module to show back link in sla menu.'} = 'Модул за приказ везе за враћање у „SLA” менију.';
    $Self->{Translation}->{'Module to show print link in service menu.'} = 'Модул за приказ везе за штампу у сервисном менију.';
    $Self->{Translation}->{'Module to show print link in sla menu.'} = 'Модул за приказ везе за штампу у „SLA” менију.';
    $Self->{Translation}->{'Module to show the link link in service menu.'} = 'Модул за приказ везе у сервисном менију.';
    ...
    $Self->{Translation}->{'Set the type and direction of links to be used to calculate the incident state. The key is the name of the link type (as defined in LinkObject::Type), and the value is the direction of the IncidentLinkType that should be followed to calculate the incident state. For example if the IncidentLinkType is set to \'DependsOn\', and the Direction is \'Source\', only \'Depends on\' links will be followed (and not the opposite link \'Required for\') to calculate the incident state. You can add more link types ad directions as you like, e.g. \'Includes\' with the direction \'Target\'. All link types defined in the sysconfig options LinkObject::Type are possible and the direction can be \'Source\', \'Target\', or \'Both\'. IMPORTANT: AFTER YOU MAKE CHANGES TO THIS SYSCONFIG OPTION YOU NEED TO RUN THE CONSOLE COMMAND bin/otrs.Console.pl Admin::ITSM::IncidentState::Recalculate SO THAT ALL INCIDENT STATES WILL BE RECALCULATED BASED ON THE NEW SETTINGS!'} =
        'Подешава тип и смер веза који ће се користити за утврђивање стања инцидента. Кључ је назив типа везе (као што је дефинисано у LinkObject::Type), а вредност је смер IncidentLinkType који треба испратити за одређивање стања инцидента. На пример, ако је IncidentLinkType подешен на DependsOn и смер је Source, само веза „Зависи од” ће бити праћена (а неће и супротна веза „Неопходно за”) у одређивању стања инцидента. Уколико желите може додати још типова и смерова веза, нпр. „Укључује” са смером „Циљ”. Сви типови веза дефинисани у системској конфигурацији „LinkObject::Type” су могући и смер може бити „Извор”, „Циљ” или „Оба”. ВАЖНО: НАКОН ИЗМЕНЕ ОПЦИЈА СИСТЕМСКЕ КОНФИГУРАЦИЈЕ МОРАТЕ ПОКРЕНУТИ СКРИПТ bin/otrs.Console.pl Admin::ITSM::IncidentState::Recalculate ДА БИ СВА ИНЦИДЕНТНА СТАЊА БИЛА ПОНОВО УТВРЂЕНА НА ОСНОВУ НОВИХ ПОДЕШАВАЊА! ';
    $Self->{Translation}->{'This setting defines that a \'ITSMChange\' object can be linked with \'Ticket\' objects using the \'Normal\' link type.'} =
        'Ово подешавање одређује да ли везом типа „Normal” објект „ITSM промена” може да се повеже са објектом „Тикет”.';
    $Self->{Translation}->{'This setting defines that a \'ITSMConfigItem\' object can be linked with \'FAQ\' objects using the \'Normal\' link type.'} =
        'Ово подешавање одређује да ли везом типа „Normal” објект „ITSM конфигурациона ставка” може да се повеже са објектом „ЧПП”.';
    $Self->{Translation}->{'This setting defines that a \'ITSMConfigItem\' object can be linked with \'FAQ\' objects using the \'ParentChild\' link type.'} =
        'Ово подешавање одређује да ли везом типа „ParentChild” објект „ITSM конфигурациона ставка” може да се повеже са објектом „ЧПП”.';
    $Self->{Translation}->{'This setting defines that a \'ITSMConfigItem\' object can be linked with \'FAQ\' objects using the \'RelevantTo\' link type.'} =
        'Ово подешавање одређује да ли везом типа „RelevantTo” објект „ITSM конфигурациона ставка” може да се повеже са објектом „ЧПП”.';
    $Self->{Translation}->{'This setting defines that a \'ITSMConfigItem\' object can be linked with \'Service\' objects using the \'AlternativeTo\' link type.'} =
        'Ово подешавање одређује да ли везом типа „AlternativeTo” објект „ITSM конфигурациона ставка” може да се повеже са објектом „Сервис”.';
    $Self->{Translation}->{'This setting defines that a \'ITSMConfigItem\' object can be linked with \'Service\' objects using the \'DependsOn\' link type.'} =
        'Ово подешавање одређује да ли везом типа „DependsOn” објект „ITSM конфигурациона ставка” може да се повеже са објектом „Сервис”.';
    $Self->{Translation}->{'This setting defines that a \'ITSMConfigItem\' object can be linked with \'Service\' objects using the \'RelevantTo\' link type.'} =
        'Ово подешавање одређује да ли везом типа „RelevantTo” објект „ITSM конфигурациона ставка” може да се повеже са објектом „Сервис”.';
    $Self->{Translation}->{'This setting defines that a \'ITSMConfigItem\' object can be linked with \'Ticket\' objects using the \'AlternativeTo\' link type.'} =
        'Ово подешавање одређује да ли везом типа „AlternativeTo” објект „ITSM конфигурациона ставка” може да се повеже са објектом „Тикет”.';
    $Self->{Translation}->{'This setting defines that a \'ITSMConfigItem\' object can be linked with \'Ticket\' objects using the \'DependsOn\' link type.'} =
        'Ово подешавање одређује да ли везом типа „DependsOn” објект „ITSM конфигурациона ставка” може да се повеже са објектом „Тикет”.';
    $Self->{Translation}->{'This setting defines that a \'ITSMConfigItem\' object can be linked with \'Ticket\' objects using the \'RelevantTo\' link type.'} =
        'Ово подешавање одређује да ли везом типа „RelevantTo” објект „ITSM конфигурациона ставка” може да се повеже са објектом „Тикет”.';
    $Self->{Translation}->{'This setting defines that a \'ITSMConfigItem\' object can be linked with other \'ITSMConfigItem\' objects using the \'AlternativeTo\' link type.'} =
        'Ово подешавање одређује да ли везом типа „AlternativeTo” објект „ITSM конфигурациона ставка” може да се повеже са другим објектом „ITSM конфигурациона ставка”.';
    $Self->{Translation}->{'This setting defines that a \'ITSMConfigItem\' object can be linked with other \'ITSMConfigItem\' objects using the \'ConnectedTo\' link type.'} =
        'Ово подешавање одређује да ли везом типа „ConnectedTo” објект „ITSM конфигурациона ставка” може да се повеже са другим објектом „ITSM конфигурациона ставка”.';
    $Self->{Translation}->{'This setting defines that a \'ITSMConfigItem\' object can be linked with other \'ITSMConfigItem\' objects using the \'DependsOn\' link type.'} =
        'Ово подешавање одређује да ли везом типа „DependsOn” објект „ITSM конфигурациона ставка” може да се повеже са другим објектом „ITSM конфигурациона ставка”.';
    $Self->{Translation}->{'This setting defines that a \'ITSMConfigItem\' object can be linked with other \'ITSMConfigItem\' objects using the \'Includes\' link type.'} =
        'Ово подешавање одређује да ли везом типа „Includes” објект „ITSM конфигурациона ставка” може да се повеже са другим објектом „ITSM конфигурациона ставка”.';
    $Self->{Translation}->{'This setting defines that a \'ITSMConfigItem\' object can be linked with other \'ITSMConfigItem\' objects using the \'RelevantTo\' link type.'} =
        'Ово подешавање одређује да ли везом типа „RelevantTo” објект „ITSM конфигурациона ставка” може да се повеже са другим објектом „ITSM конфигурациона ставка”.';
    $Self->{Translation}->{'This setting defines that a \'ITSMWorkOrder\' object can be linked with \'ITSMConfigItem\' objects using the \'DependsOn\' link type.'} =
        'Ово подешавање одређује да ли везом типа „DependsOn” објект „ITSM радни налог” може да се повеже са објектом „ITSM конфигурациона ставка”.';
    $Self->{Translation}->{'This setting defines that a \'ITSMWorkOrder\' object can be linked with \'ITSMConfigItem\' objects using the \'Normal\' link type.'} =
        'Ово подешавање одређује да ли везом типа „Normal” објект „ITSM радни налог” може да се повеже са објектом „ITSM конфигурациона ставка”.';
    $Self->{Translation}->{'This setting defines that a \'ITSMWorkOrder\' object can be linked with \'Service\' objects using the \'DependsOn\' link type.'} =
        'Ово подешавање одређује да ли везом типа „DependsOn” објект „ITSM радни налог” може да се повеже са објектом „Сервис”.';
    $Self->{Translation}->{'This setting defines that a \'ITSMWorkOrder\' object can be linked with \'Service\' objects using the \'Normal\' link type.'} =
        'Ово подешавање одређује да ли везом типа „Normal” објект „ITSM радни налог” може да се повеже са објектом „Сервис”.';
    $Self->{Translation}->{'This setting defines that a \'ITSMWorkOrder\' object can be linked with \'Ticket\' objects using the \'Normal\' link type.'} =
        'Ово подешавање одређује да ли везом типа „Normal” објект „ITSM радни налог” може да се повеже са објектом „Тикет”.';
    $Self->{Translation}->{'This setting defines that a \'Service\' object can be linked with \'FAQ\' objects using the \'Normal\' link type.'} =
        'Ово подешавање одређује да објект „Сервис” може да се повеже са објектом „ЧПП” везом типа „Normal”.';
    $Self->{Translation}->{'This setting defines that a \'Service\' object can be linked with \'FAQ\' objects using the \'ParentChild\' link type.'} =
        'Ово подешавање одређује да објект „Сервис” може да се повеже са објектом „ЧПП” везом типа „ParentChild”.';
    $Self->{Translation}->{'This setting defines that a \'Service\' object can be linked with \'FAQ\' objects using the \'RelevantTo\' link type.'} =
        'Ово подешавање одређује да објект „Сервис” може да се повеже са објектом „ЧПП” везом типа „RelevantTo”.';

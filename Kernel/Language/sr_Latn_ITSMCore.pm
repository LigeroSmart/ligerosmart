...
sub Data {
    ...
    $Self->{Translation}->{'No SLAID is given!'} = 'Nije dat ID SLA!';
    $Self->{Translation}->{'SLAID %s not found in database!'} = 'SLA ID %s nije nađen u bazi podataka!';
    $Self->{Translation}->{'Calendar Default'} = 'Podrazumevani kalendar';

    # Perl Module: Kernel/Modules/AgentITSMServicePrint.pm
    $Self->{Translation}->{'No ServiceID is given!'} = 'Nije dat ID Servisa!';
    $Self->{Translation}->{'ServiceID %s not found in database!'} = 'ID Servisa "%s" nije nađen u bazi podataka!';
    $Self->{Translation}->{'Current Incident State'} = 'Trenutno stanje incidenta';
    ...
    $Self->{Translation}->{'Set the type and direction of links to be used to calculate the incident state. The key is the name of the link type (as defined in LinkObject::Type), and the value is the direction of the IncidentLinkType that should be followed to calculate the incident state. For example if the IncidentLinkType is set to \'DependsOn\', and the Direction is \'Source\', only \'Depends on\' links will be followed (and not the opposite link \'Required for\') to calculate the incident state. You can add more link types ad directions as you like, e.g. \'Includes\' with the direction \'Target\'. All link types defined in the sysconfig options LinkObject::Type are possible and the direction can be \'Source\', \'Target\', or \'Both\'. IMPORTANT: AFTER YOU MAKE CHANGES TO THIS SYSCONFIG OPTION YOU NEED TO RUN THE CONSOLE COMMAND bin/otrs.Console.pl Admin::ITSM::IncidentState::Recalculate SO THAT ALL INCIDENT STATES WILL BE RECALCULATED BASED ON THE NEW SETTINGS!'} =
        'Podešava tip i smer veza koji će se koristiti za utvrđivanje stanja incidenta. Ključ je naziv tipa veze (kao što je definisano u LinkObject::Type), a vrednost je smer IncidentLinkType koji treba ispratiti za određivanje stanja incidenta. Na primer, ako je IncidentLinkType podešen na DependsOn i smer je Source, samo veza „Zavisi od” će biti praćena (a neće i suprotna veza „Neophodno za”) u određivanju stanja incidenta. Ukoliko želite može dodati još tipova i smerova veza, npr. „Uključuje” sa smerom „Cilj”. Svi tipovi veza definisani u sistemskoj konfiguraciji „LinkObject::Type” su mogući i smer može biti „Izvor”, „Cilj” ili „Oba”. VAŽNO: NAKON IZMENE OPCIJA SISTEMSKE KONFIGURACIJE MORATE POKRENUTI SKRIPT bin/otrs.Console.pl Admin::ITSM::IncidentState::Recalculate DA BI SVA INCIDENTNA STANJA BILA PONOVO UTVRĐENA NA OSNOVU NOVIH PODEŠAVANJA! ';
    $Self->{Translation}->{'This setting defines that a \'ITSMChange\' object can be linked with \'Ticket\' objects using the \'Normal\' link type.'} =
        'Ovo podešavanje određuje da li vezom tipa „Normal” objekt „ITSM promena” može da se poveže sa objektom „Tiket”.';
    $Self->{Translation}->{'This setting defines that a \'ITSMConfigItem\' object can be linked with \'FAQ\' objects using the \'Normal\' link type.'} =
        'Ovo podešavanje određuje da li vezom tipa „Normal” objekt „ITSM konfiguraciona stavka” može da se poveže sa objektom „ČPP”.';
    $Self->{Translation}->{'This setting defines that a \'ITSMConfigItem\' object can be linked with \'FAQ\' objects using the \'ParentChild\' link type.'} =
        'Ovo podešavanje određuje da li vezom tipa „ParentChild” objekt „ITSM konfiguraciona stavka” može da se poveže sa objektom „ČPP”.';
    $Self->{Translation}->{'This setting defines that a \'ITSMConfigItem\' object can be linked with \'FAQ\' objects using the \'RelevantTo\' link type.'} =
        'Ovo podešavanje određuje da li vezom tipa „RelevantTo” objekt „ITSM konfiguraciona stavka” može da se poveže sa objektom „ČPP”.';
    $Self->{Translation}->{'This setting defines that a \'ITSMConfigItem\' object can be linked with \'Service\' objects using the \'AlternativeTo\' link type.'} =
        'Ovo podešavanje određuje da li vezom tipa „AlternativeTo” objekt „ITSM konfiguraciona stavka” može da se poveže sa objektom „Servis”.';
    $Self->{Translation}->{'This setting defines that a \'ITSMConfigItem\' object can be linked with \'Service\' objects using the \'DependsOn\' link type.'} =
        'Ovo podešavanje određuje da li vezom tipa „DependsOn” objekt „ITSM konfiguraciona stavka” može da se poveže sa objektom „Servis”.';
    $Self->{Translation}->{'This setting defines that a \'ITSMConfigItem\' object can be linked with \'Service\' objects using the \'RelevantTo\' link type.'} =
        'Ovo podešavanje određuje da li vezom tipa „RelevantTo” objekt „ITSM konfiguraciona stavka” može da se poveže sa objektom „Servis”.';
    $Self->{Translation}->{'This setting defines that a \'ITSMConfigItem\' object can be linked with \'Ticket\' objects using the \'AlternativeTo\' link type.'} =
        'Ovo podešavanje određuje da li vezom tipa „AlternativeTo” objekt „ITSM konfiguraciona stavka” može da se poveže sa objektom „Tiket”.';
    $Self->{Translation}->{'This setting defines that a \'ITSMConfigItem\' object can be linked with \'Ticket\' objects using the \'DependsOn\' link type.'} =
        'Ovo podešavanje određuje da li vezom tipa „DependsOn” objekt „ITSM konfiguraciona stavka” može da se poveže sa objektom „Tiket”.';
    $Self->{Translation}->{'This setting defines that a \'ITSMConfigItem\' object can be linked with \'Ticket\' objects using the \'RelevantTo\' link type.'} =
        'Ovo podešavanje određuje da li vezom tipa „RelevantTo” objekt „ITSM konfiguraciona stavka” može da se poveže sa objektom „Tiket”.';
    $Self->{Translation}->{'This setting defines that a \'ITSMConfigItem\' object can be linked with other \'ITSMConfigItem\' objects using the \'AlternativeTo\' link type.'} =
        'Ovo podešavanje određuje da li vezom tipa „AlternativeTo” objekt „ITSM konfiguraciona stavka” može da se poveže sa drugim objektom „ITSM konfiguraciona stavka”.';
    $Self->{Translation}->{'This setting defines that a \'ITSMConfigItem\' object can be linked with other \'ITSMConfigItem\' objects using the \'ConnectedTo\' link type.'} =
        'Ovo podešavanje određuje da li vezom tipa „ConnectedTo” objekt „ITSM konfiguraciona stavka” može da se poveže sa drugim objektom „ITSM konfiguraciona stavka”.';
    $Self->{Translation}->{'This setting defines that a \'ITSMConfigItem\' object can be linked with other \'ITSMConfigItem\' objects using the \'DependsOn\' link type.'} =
        'Ovo podešavanje određuje da li vezom tipa „DependsOn” objekt „ITSM konfiguraciona stavka” može da se poveže sa drugim objektom „ITSM konfiguraciona stavka”.';
    $Self->{Translation}->{'This setting defines that a \'ITSMConfigItem\' object can be linked with other \'ITSMConfigItem\' objects using the \'Includes\' link type.'} =
        'Ovo podešavanje određuje da li vezom tipa „Includes” objekt „ITSM konfiguraciona stavka” može da se poveže sa drugim objektom „ITSM konfiguraciona stavka”.';
    $Self->{Translation}->{'This setting defines that a \'ITSMConfigItem\' object can be linked with other \'ITSMConfigItem\' objects using the \'RelevantTo\' link type.'} =
        'Ovo podešavanje određuje da li vezom tipa „RelevantTo” objekt „ITSM konfiguraciona stavka” može da se poveže sa drugim objektom „ITSM konfiguraciona stavka”.';
    $Self->{Translation}->{'This setting defines that a \'ITSMWorkOrder\' object can be linked with \'ITSMConfigItem\' objects using the \'DependsOn\' link type.'} =
        'Ovo podešavanje određuje da li vezom tipa „DependsOn” objekt „ITSM radni nalog” može da se poveže sa objektom „ITSM konfiguraciona stavka”.';
    $Self->{Translation}->{'This setting defines that a \'ITSMWorkOrder\' object can be linked with \'ITSMConfigItem\' objects using the \'Normal\' link type.'} =
        'Ovo podešavanje određuje da li vezom tipa „Normal” objekt „ITSM radni nalog” može da se poveže sa objektom „ITSM konfiguraciona stavka”.';
    $Self->{Translation}->{'This setting defines that a \'ITSMWorkOrder\' object can be linked with \'Service\' objects using the \'DependsOn\' link type.'} =
        'Ovo podešavanje određuje da li vezom tipa „DependsOn” objekt „ITSM radni nalog” može da se poveže sa objektom „Servis”.';
    $Self->{Translation}->{'This setting defines that a \'ITSMWorkOrder\' object can be linked with \'Service\' objects using the \'Normal\' link type.'} =
        'Ovo podešavanje određuje da li vezom tipa „Normal” objekt „ITSM radni nalog” može da se poveže sa objektom „Servis”.';
    $Self->{Translation}->{'This setting defines that a \'ITSMWorkOrder\' object can be linked with \'Ticket\' objects using the \'Normal\' link type.'} =
        'Ovo podešavanje određuje da li vezom tipa „Normal” objekt „ITSM radni nalog” može da se poveže sa objektom „Tiket”.';
    $Self->{Translation}->{'This setting defines that a \'Service\' object can be linked with \'FAQ\' objects using the \'Normal\' link type.'} =
        'Ovo podešavanje određuje da objekt „Servis” može da se poveže sa objektom „ČPP” vezom tipa „Normal”.';
    $Self->{Translation}->{'This setting defines that a \'Service\' object can be linked with \'FAQ\' objects using the \'ParentChild\' link type.'} =
        'Ovo podešavanje određuje da objekt „Servis” može da se poveže sa objektom „ČPP” vezom tipa „ParentChild”.';
    $Self->{Translation}->{'This setting defines that a \'Service\' object can be linked with \'FAQ\' objects using the \'RelevantTo\' link type.'} =
        'Ovo podešavanje određuje da objekt „Servis” može da se poveže sa objektom „ČPP” vezom tipa „RelevantTo”.';

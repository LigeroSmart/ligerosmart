...
sub Data {
    ...
    $Self->{Translation}->{'WorkOrderHistory::'} = 'Riwayat bekerja::';
    ...
    $Self->{Translation}->{'ITSM Change Management Notifications'} = 'Perubahan Pemberitahuan Manajemen ITSM';

...
# --
# $Id: hu_FAQ.pm,v 1.3 2011-11-24 17:15:12 ub Exp $
# --
...
sub Data {
    ...
    $Self->{Translation}->{'You can not delete this category. It is used in at least one FAQ article and/or is parent of at least one other category'} = 'A kategória nem törölhető. FAQ cikk használja vagy más kategória szülője!';
    ...
    $Self->{Translation}->{'You can not delete this language. It is used in at least one FAQ article!'} = 'A nyelv nem törölhető, legalább egy FAQ cikk használja!';
    ...
    # SysConfig
    $Self->{Translation}->{'A filter for HTML output to add links behind a defined string. The element Image allows two input kinds. First the name of an image (e.g. faq.png). In this case the OTRS image path will be used. The second possibility is to insert the link to the image.'} = 'Egy szűrő a HTML kimenethez, hogy hozzáadjon linkeket a definiált szövegekhez. Az Image elem kétféle bemenetet enged. A kép neve az első (pl. faq.png). Ebben az esetben az OTRS képek útvonala kerül felhasználásra. A második lehetőség a képre mutató link belillesztése.';
    ...
    $Self->{Translation}->{'Defines an overview module to show the small view of a FAQ journal.'} = 'Egy áttekintő modult definiál a FAQ journal kicsi nézetének megmutatásához.';
    $Self->{Translation}->{'Defines an overview module to show the small view of a FAQ list.'} = 'Egy áttekintő modult definiál a FAQ lista kicsi nézetének megmutatásához.';
    $Self->{Translation}->{'Defines the default FAQ attribute for FAQ sorting in a FAQ search of the agent interface.'} = 'Az alapértelmezett FAQ attribútumokat definiálja a FAQ rendezéshez az ügyintéző felületén a FAQ keresésnél.';
    ...
    $Self->{Translation}->{'Defines the default FAQ attribute for FAQ sorting in the FAQ Explorer of the agent interface.'} = 'Az alapértelmezett FAQ attribútumokat definiálja a FAQ rendezéshez az ügyintéző felületén a FAQ böngészőnél.';
    $Self->{Translation}->{'Defines the default FAQ attribute for FAQ sorting in the FAQ Explorer of the customer interface.'} = 'Az alapértelmezett FAQ attribútumokat definiálja a FAQ rendezéshez az ügyfél felületén a FAQ böngészőnél.';
    $Self->{Translation}->{'Defines the default FAQ attribute for FAQ sorting in the FAQ Explorer of the public interface.'} = 'Az alapértelmezett FAQ attribútumokat definiálja a FAQ rendezéshez a nyilvános felületen a FAQ böngészőnél.';
    $Self->{Translation}->{'Defines the default FAQ order in the FAQ Explorer result of the agent interface. Up: oldest on top. Down: latest on top.'} = 'Az alapértelmezett FAQ sorrendet definiálja a FAQ böngészőben az ügyintéző felületén. Up: régebbiek felül, Down: legfrissebb felül.';
    $Self->{Translation}->{'Defines the default FAQ order in the FAQ Explorer result of the customer interface. Up: oldest on top. Down: latest on top.'} = 'Az alapértelmezett FAQ sorrendet definiálja a FAQ böngészőben az ügyfél felületén. Up: régebbiek felül, Down: legfrissebb felül.';
    $Self->{Translation}->{'Defines the default FAQ order in the FAQ Explorer result of the public interface. Up: oldest on top. Down: latest on top.'} = 'Az alapértelmezett FAQ sorrendet definiálja a FAQ böngészőben a nyilvános felületen. Up: régebbiek felül, Down: legfrissebb felül.';
    $Self->{Translation}->{'Defines the default FAQ order of a search result in the agent interface. Up: oldest on top. Down: latest on top.'} = 'Az alapértelmezett FAQ sorrendet definiálja a keresésnél az ügyintéző felületén. Up: régebbiek felül, Down: legfrissebb felül.';
    ...
    $Self->{Translation}->{'Defines the shown columns in the FAQ Explorer. This option has no effect on the position of the column.'} = 'A FAQ böngészőben látható oszlopokat definiálja. A paraméter nincs hatással az oszlop pozíciójára.';
    ...
    $Self->{Translation}->{'Maximum number of FAQ articles to be displayed in the FAQ Explorer result of the agent interface.'} = 'A megjelenő FAQ cikkek maximális száma a FAQ böngésző ügyintéző felületén.';
    $Self->{Translation}->{'Maximum number of FAQ articles to be displayed in the FAQ Explorer result of the customer interface.'} = 'A megjelenő FAQ cikkek maximális száma a FAQ böngésző ügyfél felületén.';
    $Self->{Translation}->{'Maximum number of FAQ articles to be displayed in the FAQ Explorer result of the public interface.'} = 'A megjelenő FAQ cikkek maximális száma a FAQ böngésző nyilvános felületén.';
    $Self->{Translation}->{'Maximum number of FAQ articles to be displayed in the FAQ journal in the agent interface.'} = 'A megjelenő FAQ cikkek maximális száma a FAQ journal ügyintéző felületén.';
    $Self->{Translation}->{'Maximum number of FAQ articles to be displayed in the result of a search in the agent interface.'} = 'A megjelenő FAQ cikkek maximális száma a keresésnél az ügyintéző felületén.';
    $Self->{Translation}->{'Maximum number of FAQ articles to be displayed in the result of a search in the customer interface.'} = 'A megjelenő FAQ cikkek maximális száma a keresésnél az ügyfél felületén.';
    $Self->{Translation}->{'Maximum number of FAQ articles to be displayed in the result of a search in the public interface.'} = 'A megjelenő FAQ cikkek maximális száma a keresésnél a nyilvános felületen.';
    ...
    $Self->{Translation}->{'Number of FAQ articles to be displayed in the FAQ Explorer of the customer interface.'} = 'A megjelenő FAQ cikkek száma a FAQ böngésző ügyintéző felületén.';
    $Self->{Translation}->{'Number of FAQ articles to be displayed in the FAQ Explorer of the public interface.'} = 'A megjelenő FAQ cikkek száma a FAQ böngésző nyilvános felületén.';
    $Self->{Translation}->{'Number of FAQ articles to be displayed on each page of a search result in the customer interface.'} = 'A megjelenő FAQ cikkek száma minden lapon a keresésnél az ügyfél felületén.';
    $Self->{Translation}->{'Number of FAQ articles to be displayed on each page of a search result in the public interface.'} = 'A megjelenő FAQ cikkek száma minden lapon a keresésnél a nyilvános felületen.';
    ...
    $Self->{Translation}->{'Shows a link in the menu that allows linking a FAQ with another object in the zoom view of such FAQ of the agent interface.'} = 'Link megjelenítése a menüben ami engedi a FAQ linkelését más objektumokkal a FAQ részleteinél az ügyintéző felületén.';
    $Self->{Translation}->{'Shows a link in the menu that allows to delete a FAQ in its zoom view in the agent interface.'} = 'Link megjelenítése a menüben ami engedi a FAQ törlését a FAQ részleteinél az ügyintéző felületén.';
    $Self->{Translation}->{'Shows a link in the menu to access the history of a FAQ in its zoom view of the agent interface.'} = 'Link megjelenítése a menüben ami eléri a FAQ történetét a FAQ részleteinél az ügyintéző felületén.';
    $Self->{Translation}->{'Shows a link in the menu to edit a FAQ in the its zoom view of the agent interface.'} = 'Link megjelenítése a menüben ami engedi a FAQ szerkesztését a FAQ részleteinél az ügyintéző felületén.';
    $Self->{Translation}->{'Shows a link in the menu to go back in the FAQ zoom view of the agent interface.'} = 'Link megjelenítése a menüben ami engedi a visszalépést a FAQ részleteinél az ügyintéző felületén.';
    $Self->{Translation}->{'Shows a link in the menu to print a FAQ in the its zoom view of the agent interface.'} = 'Link megjelenítése a menüben ami engedi a FAQ nyomtatását a FAQ részleteinél az ügyintéző felületén.';

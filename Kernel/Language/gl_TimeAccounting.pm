# --
# Kernel/Language/gl_TimeAccounting.pm - translation file
...
sub Data {
    ...
    $Self->{Translation}->{'Show valid projects'} = 'Mostrar os proxectos válidos';
    $Self->{Translation}->{'Show all projects'} = 'Mostrar todos os proxectos';
    $Self->{Translation}->{'TimeAccounting'} = 'ContabilizarTempo';
    ...
    $Self->{Translation}->{'Go to this date'} = 'Ir a esta data';
    ...
    $Self->{Translation}->{'Please add a remark with more than 8 characters!.'} = 'Engada unha observación con máis de 8 caracteres!';
    ...
    $Self->{Translation}->{'Show all items'} = 'Mostrar todos os elementos';
    ...
    $Self->{Translation}->{'New user'} = 'Novo usuario';
    $Self->{Translation}->{'Filter for Projects'} = 'Filtrar por proxectos';
    $Self->{Translation}->{'Filter for Tasks'} = 'Filtrar por tarefas';
    $Self->{Translation}->{'Filter for Users'} = 'Filtrar por usuarios';
    ...
    $Self->{Translation}->{'New User Settings'} = 'Axustes Novo Usuario';
    $Self->{Translation}->{'Edit User Settings'} = 'Axustes Editar Usuario';
    ...
    $Self->{Translation}->{'Edit time accounting settings'} = 'Edite axustes de contabilización de tempo';
    $Self->{Translation}->{'Edit time record'} = 'Edite rexistro de tempo';
    ...
    $Self->{Translation}->{'If enabled, the dropdown elements in the edit screen are changed to autocompletion fields.'} =
        'Se habilitado, os elementos do despregable na pantalla editar son cambiados por campos autocompletables.';
    ...
    $Self->{Translation}->{'Project time reporting'} = 'Informe de tempo de proxecto';

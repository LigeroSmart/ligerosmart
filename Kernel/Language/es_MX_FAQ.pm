...
# --
# $Id: es_MX_FAQ.pm,v 1.11 2011-01-14 17:30:24 ub Exp $
# --
...
sub Data {
    ...
    $Self->{Translation}->{'Add FAQ Article'} = 'Agregar FAQ.';
    ...
    $Self->{Translation}->{'Will be shown as comment in Explorer.'} = 'Seran mostrados como comentarios en Explorer.';
    ...
    $Self->{Translation}->{'FAQ path separator.'} = 'Separador de la ruta del FAQ.';
    ...
    $Self->{Translation}->{'Maximum number of FAQ articles to be displayed in the FAQ journal in the agent interface.'} = 'Número máximo de artículos FAQ a ser mostrados como en la bitácora de FAQ en la interface del agente.';
    ...
    $Self->{Translation}->{'Shows a link in the menu that allows linking a FAQ with another object in the zoom view of such FAQ of the agent interface.'} = 'Muestra un liga en el menú que permite ligar un artículo FAQ con otros objetos en su vista de detalles en la interface del agente.';
    $Self->{Translation}->{'Shows a link in the menu that allows to delete a FAQ in its zoom view in the agent interface.'} = 'Muestra un liga en el menú que permite borrar un artículo FAQ en su vista de detalles en la interface del agente.';
    $Self->{Translation}->{'Shows a link in the menu to access the history of a FAQ in its zoom view of the agent interface.'} = '';
    $Self->{Translation}->{'Shows a link in the menu to edit a FAQ in the its zoom view of the agent interface.'} = 'Muestra un liga en el menú para editar un artículo FAQ en su vista de detalles en la interface del agente.';
    $Self->{Translation}->{'Shows a link in the menu to go back in the FAQ zoom view of the agent interface.'} = 'Muestra un liga en el menú para ir hacia atras en la vista de detalles de FAQ en la interface del agente.';
    $Self->{Translation}->{'Shows a link in the menu to print a FAQ in the its zoom view of the agent interface.'} = 'Muestra un liga en el menú para imprimir un artículo FAQ en su vista de detalles en la interface del agente.';
    ...
    $Self->{Translation}->{'This setting defines that a \'FAQ\' object can be linked with other \'FAQ\' objects using the \'Normal\' link type.'} = 'Este ajuste define que un objeto \'FAQ\' puede ligarse con otros objetos \'FAQ\' utilizando el tipo de liga \'Normal\'.';
    $Self->{Translation}->{'This setting defines that a \'FAQ\' object can be linked with other \'FAQ\' objects using the \'ParentChild\' link type.'} = 'Este ajuste define que un objeto \'FAQ\' puede ligarse con otros objetos \'FAQ\' utilizando el tipo de liga \'ParentChild\'.';
    $Self->{Translation}->{'This setting defines that a \'FAQ\' object can be linked with other \'Ticket\' objects using the \'Normal\' link type.'} = 'Este ajuste define que un objeto \'FAQ\' puede ligarse con otros objetos \'Ticket\' utilizando el tipo de liga \'Normal\'.';
    $Self->{Translation}->{'This setting defines that a \'FAQ\' object can be linked with other \'Ticket\' objects using the \'ParentChild\' link type.'} = 'Este ajuste define que un objeto \'FAQ\' puede ligarse con otros objetos \'Ticket\' utilizando el tipo de liga \'ParentChild\'.';

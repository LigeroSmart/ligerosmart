# --
# Kernel/Language/sw_ImportExport.pm - translation file
...
sub Data {
    ...
    $Self->{Translation}->{'Step'} = 'Hatua';
    $Self->{Translation}->{'Edit common information'} = 'Hariri taarifa za kufana';
    ...
    $Self->{Translation}->{'Edit object information'} = 'Hariri taarifa za kipengee';
    $Self->{Translation}->{'Edit format information'} = 'Hariri taarifa za umbizo';
    $Self->{Translation}->{'is required!'} = 'Inahitajika';
    $Self->{Translation}->{'Edit mapping information'} = 'Hariri tarifa za kuweka ramani';
    ...
    $Self->{Translation}->{'Edit search information'} = 'Hariri taarifa za kutafuta';

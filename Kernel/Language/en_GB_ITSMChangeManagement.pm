...
sub Data {
    ...
    $Self->{Translation}->{'Change and WorkOrder templates edited by this user.'} = 'Change and WorkOrder templates edited by this user.';
    ...
    $Self->{Translation}->{'Delete Change'} = 'Delete Change';
    ...
    $Self->{Translation}->{'Reset change and its workorders'} = 'Reset change and its workorders';

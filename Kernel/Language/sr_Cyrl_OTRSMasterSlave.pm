...
sub Data {
    ...
    $Self->{Translation}->{'Change Free Text of %s%s'} = 'Промени слободни текст за %s%s';
    $Self->{Translation}->{'Change Owner of %s%s'} = 'Промени власника за %s%s';
    $Self->{Translation}->{'Close %s%s'} = 'Затвори %s%s';
    $Self->{Translation}->{'Add Note to %s%s'} = 'Додај обавештење %s%s';
    $Self->{Translation}->{'Set Pending Time for %s%s'} = 'Постави време чекања за %s%s';
    $Self->{Translation}->{'Change Priority of %s%s'} = 'Промени приоритет за %s%s';
    $Self->{Translation}->{'Change Responsible of %s%s'} = 'Промени одговорног за %s%s';
    ...
    $Self->{Translation}->{'Text will also be received by:'} = 'Текст ће примити и:';

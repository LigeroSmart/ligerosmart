# --
# Kernel/Language/sw_ITSMChangeManagement.pm - translation file
...
sub Data {
    ...
    $Self->{Translation}->{'A a valid name is needed.'} = 'Jina halali linahitajika.';
    ...
    $Self->{Translation}->{'Agent interface notification module to see the number of work orders.'} =
        'Moduli taarifa ya kiolesura cha wakala kuona idadi ya oda za kazi.';
    ...
    $Self->{Translation}->{'ITSM event module updates the history of changes.'} = 'Moduli ya matukio ya ITSM inayosasisha historia ya mabadiliko.';
    $Self->{Translation}->{'ITSM event module updates the history of conditions.'} = 'Moduli ya matukio ya ITSM inayosasisha historia ya masharti.';
    $Self->{Translation}->{'ITSM event module updates the history of workorders.'} = 'Moduli ya matukio ya ITSM inayosasisha historia ya oda za kazi.';
    ...
    $Self->{Translation}->{'Show this screen after I created a new workorder'} = 'Onyesha skrini hii baada ya kutengeneza oda mpya ya kazi.';
    ...
    $Self->{Translation}->{'Shows a link in the menu that allows changing the work order agent, in the zoom view of such work order of the agent interface.'} =
        'Inaonyesha kiungo kwenye menyu kinachoruhusu kubadilisha wakala wa oda ya kazi, katika muonekano uliokuzwa wa oda hiyo ya kazi ya kiolesura cha wakala.';
    ...
    $Self->{Translation}->{'Shows a link in the menu that allows defining a work order as a template in the zoom view of the work order, in the agent interface.'} =
        'Inaonyesha kiungo kwenye menyu  kinachoruhusu kufafanua oda ya kazi kama kiolezo katika muonekano uliokuzwa wa oda ya kazi, katika kiolesura cha wakala.';
    $Self->{Translation}->{'Shows a link in the menu that allows editing the report of a workd order, in the zoom view of such work order of the agent interface.'} =
        'Inaonyesha kiungo kwenye menyu  kinachoruhusu kuhariri ripoti ya oda ya kazi, katika muonekano uliokuzwa wa oda hiyo ya kazi, katika kiolesura cha wakala.';
    ...
    $Self->{Translation}->{'Shows a link in the menu that allows linking a work order with another object in the zoom view of such work order of the agent interface.'} =
        'Inaonyesha kiungo kwenye menyu  kinachoruhusu kuunganisha oda ya kazi na kitu kingine katika muonekano uliokuzwa wa oda ya kazi wa kiolesura cha wakala.';
    ...
    $Self->{Translation}->{'Shows a link in the menu that allows taking a work order in the its zoom view of the agent interface.'} =
        'Inaonyesha kiungo kwenye menyu ambacho kinaruhusu kuchukua oda ya kazi katika muonekano wake uliokuzwa wa kiolesura cha wakala. ';
    ...
    $Self->{Translation}->{'Shows a link in the menu to access the history of a work order in the its zoom view of the agent interface.'} =
        'Inaonyesha kiungo kwenye menyu ili kufikia historia ya oda ya kazi katika muonekano wake uliokuzwa wa kiolesura cha wakala. ';
    $Self->{Translation}->{'Shows a link in the menu to add a work order in the change zoom view of the agent interface.'} =
        'Inaonyesha kiungo kwenye menyu ili kuongeza oda ya kazi katika muonekano uliokuzwa wa mabadiliko wa kiolesura cha wakala. ';
    ...
    $Self->{Translation}->{'Shows a link in the menu to delete a work order in its zoom view of the agent interface.'} =
        'Inaonyesha kiungo kwenye menyu ili kufuta oda ya kazi katika muonekano wake uliokuzwa wa kiolesura cha wakala. ';
    ...
    $Self->{Translation}->{'Shows a link in the menu to edit a work order in the its zoom view of the agent interface.'} =
        'Inaonyesha kiungo kwenye menyu ili kuhariri oda ya kazi katika muonekano wake uliokuzwa wa kiolesura cha wakala. ';
    ...
    $Self->{Translation}->{'Shows a link in the menu to go back in the work order zoom view of the agent interface.'} =
        'Inaonyesha kiungo kwenye menyu ili kurudi nyuma kwenye muonekano wa oda za kazi uliokuzwa wa kiolesura cha wakala. ';
    ...
    $Self->{Translation}->{'Shows a link in the menu to print a work order in the its zoom view of the agent interface.'} =
        'Inaonyesha kiungo kwenye menyu ili kuchapisha oda ya kazi kwenye muonekano wake uliokuzwa wa kiolesura cha wakala. ';

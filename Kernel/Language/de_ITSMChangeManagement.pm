...
# --
# $Id: de_ITSMChangeManagement.pm,v 1.63 2010-02-08 11:22:53 bes Exp $
# --
...
sub Data {
    ...
    $Lang->{'WorkOrderAttribute::ChangeBy'}         = 'Geändert von';
    $Lang->{'WorkOrderAttribute::ChangeTime'}       = 'Geändert von';

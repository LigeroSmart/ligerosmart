...
sub Data {
    ...
    $Self->{Translation}->{'Allows adding notes in the ticket MasterSlave screen of a zoomed ticket in the agent interface.'} =
        'Pozwala na dodanie notatki na ekranie NadrzędnyPodrzędny, wywołanym z przybliżonego widoku zgłoszenia w interfejsie agenta.';
    ...
    $Self->{Translation}->{'Defines if a ticket lock is required in the ticket MasterSlave screen of a zoomed ticket in the agent interface (if the ticket isn\'t locked yet, the ticket gets locked and the current agent will be set automatically as its owner).'} =
        'Określa, czy wymagana jest zablokowanie zgłoszenia na ekranie NadrzędnyPodrzędny w oknie szczegółów zgłoszenia interfejsu agenta (jeśli zgłoszenie nie jest jeszcze zablokowane, staje się zablokowane, a bieżący agent staje się jego właścicielem).';
    $Self->{Translation}->{'Defines the default next state of a ticket after adding a note, in the ticket MasterSlave screen of a zoomed ticket in the agent interface.'} =
        'Określa domyślny następny stan zgłoszenia po dodaniu notatki na ekranie NadrzędnyPodrzędny w oknie szczegółów zgłoszenia interfejsu agenta.';
    $Self->{Translation}->{'Defines the default ticket priority in the ticket MasterSlave screen of a zoomed ticket in the agent interface.'} =
        'Określa domyślny priorytet zgłoszenia na ekranie NadrzędnyPodrzędny w oknie szczegółów zgłoszenia interfejsu agenta.';
    $Self->{Translation}->{'Defines the default type of the note in the ticket MasterSlave screen of a zoomed ticket in the agent interface.'} =
        'Określa domyślny typ notatki notatki na ekranie NadrzędnyPodrzędny w oknie szczegółów zgłoszenia interfejsu agenta.';
    $Self->{Translation}->{'Defines the history comment for the ticket MasterSlave screen action, which gets used for ticket history in the agent interface.'} =
        'Określa komentarz historii dla akcji zgłoszenia na ekranie NadrzędnyPodrzędny który zostanie użyty w historii zgłoszenia interfejsu agenta.';
    ...
    $Self->{Translation}->{'Enables the feature to change the MasterSlave state of a ticket in the advanced MasterSlave mode.'} =
        'Włącza funkcjonalność trybu zaawansowanego NadrzędnyPodrzędny umożliwiającą zmianę stanu NadrzędnyPodrzędny w zgłoszeniu.';
    ...
    $Self->{Translation}->{'Enables the feature to keep parent-child link after change of the MasterSlave state in the advanced MasterSlave mode.'} =
        'Włącza funkcjonalność trybu zaawansowanego NadrzędnyPodrzędny, polegającą na utrzymaniu połączenia rodzic-dziecko po zmianie zależności NadrzędnyPodrzędny.';
    $Self->{Translation}->{'Enables the feature to keep parent-child link after unset of the MasterSlave state in the advanced MasterSlave mode.'} =
        'Włącza funkcjonalność trybu zaawansowanego NadrzędnyPodrzędny, polegającą na utrzymaniu połączenia rodzic-dziecko po usunięciu zależności NadrzędnyPodrzędny.';
    $Self->{Translation}->{'Enables the feature to unset the MasterSlave state of a ticket in the advanced MasterSlave mode.'} =
        'Włącza funkcjonalność trybu zaawansowanego NadrzędnyPodrzędny, usuwania stanu NadrzędnyPodrzędny ze zgłoszenia.';
    $Self->{Translation}->{'If a note is added by an agent, sets the state of the ticket in the ticket MasterSlave screen of a zoomed ticket in the agent interface.'} =
        'Jeśli agent doda notatkę, to ustawiany jest stan zgłoszenia na ekranie NadrzędnyPodrzędny okna szczegółów zgłoszenia interfejsu agenta.';
    $Self->{Translation}->{'Master / Slave'} = 'Nadrzędny / Podrzędny';
    $Self->{Translation}->{'Master Tickets'} = 'Zgłoszenia nadrzędne';
    $Self->{Translation}->{'MasterSlave'} = 'NadrzędnyPodrzędny';
    $Self->{Translation}->{'MasterSlave module for Ticket Bulk feature.'} = 'Moduł NadrzędnychPodrzędnych dla funkcji grupowych zgłoszeń.';
    ...
    $Self->{Translation}->{'Required permissions to use the ticket MasterSlave screen of a zoomed ticket in the agent interface.'} =
        'Uprawnienia wymagane do używania ekranu NadrzędnyPodrzędny w oknie szczegółów zgłoszenia interfejsu agenta.';
    $Self->{Translation}->{'Sets the default body text for notes added in the ticket MasterSlave screen of a zoomed ticket in the agent interface.'} =
        'Ustawia domyślną treść notatki dodawanej do zgłoszenia na ekranie NadrzędnyPodrzędny w oknie szczegółów zgłoszenia interfejsu agenta.';
    $Self->{Translation}->{'Sets the default subject for notes added in the ticket MasterSlave screen of a zoomed ticket in the agent interface.'} =
        'Ustawia domyślny temat dla notatek dodawanych do zgłoszenia na ekranie NadrzędnyPodrzędny w oknie szczegółów zgłoszenia interfejsu agenta.';
    $Self->{Translation}->{'Sets the responsible agent of the ticket in the ticket MasterSlave screen of a zoomed ticket in the agent interface.'} =
        'Ustawia odpowiedzialnego za zgłoszenie agenta na ekranie NadrzędnyPodrzędny w oknie szczegółów zgłoszenia interfejsu agenta.';
    $Self->{Translation}->{'Sets the service in the ticket MasterSlave screen of a zoomed ticket in the agent interface (Ticket::Service needs to be activated).'} =
        'Ustawia usługę w zgłoszeniu na ekranie NadrzędnyPodrzędny w oknie szczegółów zgłoszenia interfejsu agenta (Ticket::Service musi być aktywowane).';
    $Self->{Translation}->{'Sets the ticket owner in the ticket MasterSlave screen of a zoomed ticket in the agent interface.'} =
        'Ustawia właściciela zgłoszenia na ekranie NadrzędnyPodrzędny w oknie szczegółów zgłoszenia interfejsu agenta.';
    $Self->{Translation}->{'Sets the ticket type in the ticket MasterSlave screen of a zoomed ticket in the agent interface (Ticket::Type needs to be activated).'} =
        'Ustawia typ zgłoszenia na ekranie NadrzędnyPodrzędny, wywołanym z przybliżonego widoku zgłoszenia w interfejsie agent (Ticket::Type musi być aktywowany).';
    $Self->{Translation}->{'Shows a link in the menu to change the MasterSlave status of a ticket in the ticket zoom view of the agent interface.'} =
        'Na ekranie przybliżonego widoku zgłoszenia w interfejsie agenta, pokazuje link w menu do zmiany stanu NadrzędnyPodrzędny.';
    $Self->{Translation}->{'Shows a list of all the involved agents on this ticket, in the ticket MasterSlave screen of a zoomed ticket in the agent interface.'} =
        'Na ekranie NadrzędnyPodrzędny, wywołanym z przybliżonego widoku zgłoszenia w interfejsie agenta, pokazuje listę wszystkich agentów zaangażowanych w zgłoszenie.';
    $Self->{Translation}->{'Shows a list of all the possible agents (all agents with note permissions on the queue/ticket) to determine who should be informed about this note, in the ticket MasterSlave screen of a zoomed ticket in the agent interface.'} =
        'Na ekranie NadrzędnyPodrzędny, wywołanym z przybliżonego widoku zgłoszenia w interfejsie agenta, pokazuje listę wszystkich możliwych agentów (wszystkich agentów z uprawnieniami do notatek w kolejce/zgłoszeniu), w celu określenia kto powinien być poinformowany o tej notatce.';
    $Self->{Translation}->{'Shows the ticket priority options in the ticket MasterSlave screen of a zoomed ticket in the agent interface.'} =
        'Pokazuje opcje priorytetu zgłoszenia na ekranie NadrzędnyPodrzędny, wywołanym z przybliżonego widoku zgłoszenia w interfejsie agenta';
    $Self->{Translation}->{'Shows the title fields in the ticket MasterSlave screen of a zoomed ticket in the agent interface.'} =
        'Pokazuje pola tytułowe w oknie NadrzędnyPodrzędny przybliżonego zgłoszenia w interfejsie agenta.';
    ...
    $Self->{Translation}->{'Ticket MasterSlave.'} = 'Zgłoszenie NadrzędnePodrzędne';

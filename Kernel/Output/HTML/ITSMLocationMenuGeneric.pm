...
# --
# $Id: ITSMLocationMenuGeneric.pm,v 1.1 2008-06-21 12:54:05 ub Exp $
# --
...
package Kernel::Output::HTML::ITSMLocationMenuGeneric;
...
sub new {
    ...
    for my $Object (qw(ConfigObject LogObject DBObject LayoutObject LocationObject UserID)) {
...
sub Run {
    ...
    # check needed stuff
    if ( !$Param{Location} ) {
        $Self->{LogObject}->Log( Priority => 'error', Message => 'Need Location!' );
        return;
    }

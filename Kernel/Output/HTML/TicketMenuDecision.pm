...
# --
# $Id: TicketMenuDecision.pm,v 1.1.1.1 2008-06-30 08:58:41 ub Exp $
# --
...
package Kernel::Output::HTML::TicketMenuDecision;
        ...
        )
    {
        ...
        $Self->{LayoutObject}->Block(
            ...
            Data => {
                ...
                Link        => 'Action=AgentTicketDecision&TicketID=$QData{"TicketID"}',
            },
        );

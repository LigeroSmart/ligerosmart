...
package Kernel::Modules::AdminDynamicFieldFile;
...
sub _ShowScreen {
    ...
    $Output .= $LayoutObject->Output(
        TemplateFile => 'AdminDynamicFieldFile',
        Data         => {
            %Param,

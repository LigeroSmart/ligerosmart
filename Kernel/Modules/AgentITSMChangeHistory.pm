...
# --
# $Id: AgentITSMChangeHistory.pm,v 1.47 2010-09-27 22:50:05 en Exp $
# --
...
sub Run {
    ...
    if ( !$Change ) {
        return $Self->{LayoutObject}->ErrorScreen(
            Message => "Change '$ChangeID' not found in data base!",
            Comment => 'Please contact the administrator.',
        );
    }
    ...
    # if there is no data to show, a message is displayed
    if ( !@HistoryLines ) {

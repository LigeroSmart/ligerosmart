...
sub Configure {
    ...
    $Self->Description('Reinstall an LigeroSmart package.');
    $Self->AddOption(
        Name        => 'force',
    ...
    $Self->AddArgument(
        Name => 'location',
        Description =>
            "Specify a file path, a remote repository (http://ftp.ligerosmart.org/pub/otrs/packages/:Package-1.0.0.opm) or just any online repository (online:Package).",
        Required   => 1,
        ValueRegex => qr/.*/smx,
    );

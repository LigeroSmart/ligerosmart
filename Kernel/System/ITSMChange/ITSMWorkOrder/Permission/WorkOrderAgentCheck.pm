...
# --
# $Id: WorkOrderAgentCheck.pm,v 1.1 2009-11-04 09:53:33 bes Exp $
# --
...
sub Run {
    ...
    # workorder agents are not allowed to create workorders
    return if !$Param{WorkOrderID};
    ...
    # deny access, when nowork order was found

# --
# Kernel/System/DynamicField/Driver/BaseToFile.pm - Dynamic field backend functions
...
package Kernel::System::DynamicField::Driver::BaseToFile;
...
Kernel::System::DynamicField::Driver::BaseToFile - common fields backend functions
...
sub ValueDelete {
    ...
    my $Success = $Kernel::OM->Get('Kernel::System::DynamicFieldFileValue')->ValueDelete(
...
sub AllValuesDelete {
    ...
    my $Success = $Kernel::OM->Get('Kernel::System::DynamicFieldFileValue')->AllValuesDelete(
        FieldID => $Param{DynamicFieldConfig}->{ID},
        UserID  => $Param{UserID},
    );

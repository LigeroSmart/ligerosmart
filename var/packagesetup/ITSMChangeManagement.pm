...
sub _AddSystemNotifications {
    ...
    my @AgentNotifications = (
        ...
        [
            ...
            'de',
            '[Workorder #<OTRS_CHANGE_ChangeNumber>-<OTRS_WORKORDER_WorkOrderNumber>] Ticket verknöpft',
            'Die Workorder #<OTRS_CHANGE_ChangeNumber>-<OTRS_WORKORDER_WorkOrderNumber> wurde mit einem Ticket verknöpft.'
                . $BasicWorkOrderInfoDe,
        ],
        [
            'Agent::WorkOrder::WorkOrderLinkAdd',
